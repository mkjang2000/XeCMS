...
const environment={...process.env,NODE_ENV:"development",XECMS_HOST:"127.0.0.1",XECMS_PORT:new URL(serverUrl).port||"80",XECMS_ADMIN_ORIGINS:serverUrl,XECMS_CONTENT_ORIGINS:serverUrl,DATABASE_URL:databaseUrl,XECMS_TEST_DATABASE_URL:databaseUrl,XECMS_E2E_DATABASE_URL:databaseUrl,XECMS_DB_SCHEMA:process.env.XECMS_M4C4_DB_SCHEMA??`xecms_m4c4_e2e_${process.pid}_${Date.now()}`,XECMS_RUN_POSTGRES_TESTS:"true",XECMS_DEV_SEED:"true",XECMS_DEV_ADMIN_USERNAME:"admin",XECMS_DEV_ADMIN_PASSWORD:"admin",XECMS_E2E_OWNER_PASSWORD:"admin",XECMS_SESSION_SECRET:"m4c4-e2e-only-session-secret-change-me",XECMS_ADMIN_DIST:fileURLToPath(new URL("apps/admin/dist",rootDirectory)),XECMS_SERVER_URL:serverUrl,XECMS_E2E_ADMIN_URL:serverUrl,XECMS_WORKER_ENABLED:"false"};

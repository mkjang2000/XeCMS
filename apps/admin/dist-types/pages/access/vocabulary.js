...
export const permissionObjectNames = {
    authorization: "권한 정책",
    content: "콘텐츠",
    revision: "버전",
    schema: "스키마",
...
export const permissionVerbNames = {
    list: "목록 보기",
    read: "보기",
    create: "만들기",
    update: "수정",
...
export function permissionCategoryName(category) {
    return permissionCategoryNames[category] ?? category;
}
export function permissionTaskName(key) {
...
export function propagationLabel(propagation) {
    switch (propagation) {
...
export function hierarchyContextDescription(guard) {
    switch (guard) {
...
export function decisionReasonName(code) {
    const names = {

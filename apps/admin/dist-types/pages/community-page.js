...
export function CommunityPage() {
    ...
    if (loading)
        return _jsx("main", { className: styles.center, children: _jsx("div", { className: styles.loading, children: "Content Realm\uC744 \uBD88\uB7EC\uC624\uB294 \uC911\u2026" }) });
    if (metadata === null || session === null) {
        return _jsx("main", { className: styles.center, children: _jsx(ErrorCard, { message: error ?? "Realm을 불러올 수 없습니다." }) });
    }

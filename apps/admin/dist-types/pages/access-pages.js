...
export function AccessRolesPage() {
    ...
    return (_jsxs(Page, { children: [_jsx(PageHeader, { eyebrow: realmId ? "Content Realm authorization" : "System authorization", title: "\uB808\uBCA8\uACFC \uC5ED\uD560", description: "\uB808\uBCA8\uC740 \uAD00\uB9AC \uC11C\uC5F4\uC744, \uAC19\uC740 \uB808\uBCA8\uC758 \uC5ED\uD560\uC740 \uC11C\uB85C \uB2E4\uB978 \uCC45\uC784 \uC601\uC5ED\uC744 \uD45C\uD604\uD569\uB2C8\uB2E4.", actions: _jsx(Button, { onPress: () => selectLevel(null), children: "\uC0C8 \uB808\uBCA8" }) }), _jsx(AccessWorkspaceNav, {}), _jsx(PolicySummary, { policy: policy.data }), _jsxs("div", { className: `${styles.layout} ${styles.rolesLayout}`, children: [_jsx("div", { className: styles.levels, children: levels.map((level) => {
                            const roles = policy.data.roles.filter((role) => role.levelId === level.id);
                            return (_jsxs("section", { className: styles.levelCard, children: [_jsxs("div", { className: styles.levelHeader, children: [_jsxs("div", { className: styles.levelIdentity, children: [_jsxs("span", { className: styles.rank, children: ["L", level.rank] }), _jsxs("div", { children: [_jsx("h2", { children: level.name }), _jsxs("span", { className: styles.hint, children: ["\uB3D9\uC77C \uB808\uBCA8 \uC5ED\uD560 ", roles.length, "\uAC1C"] })] })] }), _jsxs("div", { className: styles.levelActions, children: [_jsx(Button, { size: "small", variant: "secondary", onPress: () => createRoleAt(level), children: "\uB3D9\uC77C \uB808\uBCA8 \uC5ED\uD560 \uCD94\uAC00" }), !level.protected
...
function RoleEditor({ policy, role, onSave, onDelete, onCancel, isPending }) {
    ...
    return (_jsxs("section", { className: styles.panel, "aria-label": "\uC5ED\uD560 \uD3B8\uC9D1\uAE30", children: [_jsx(SectionHeader, { title: readOnly ? "보호 역할 상세" : role.id ? "역할 편집" : "동일 레벨 역할 추가", description: readOnly ? "시스템 보호 역할은 구성을 확인할 수 있지만 수정할 수 없습니다." : "사용 권한과 하위 역할에 위임할 수 있는 범위를 분리합니다.", actions: readOnly ? _jsx(Badge, { children: "\uC77D\uAE30 \uC804\uC6A9" }) : undefined }), readOnly ? _jsx(Callout, { tone: "info", children: "\uC774 \uC5ED\uD560\uC740 \uC2DC\uC2A4\uD15C \uB3D9\uC791\uC5D0 \uD544\uC694\uD558\uBBC0\uB85C \uC774\uB984, \uB808\uBCA8, \uAD8C\uD55C \uAD6C\uC131\uC774 \uBCF4\uD638\uB429\uB2C8\uB2E4." }) : null, _jsxs("div", { className: styles.form, children: [_jsxs("label", { className: styles.field, children: [_jsx("span", { children: "\uC5ED\uD560 \uC774\uB984" }), _jsx("input", { value: name, disabled: readOnly, onChange: (event) => setName(event.target.value) })] }), _jsxs("label", { className: styles.field, children: [_jsx("span", { children: "\uC124\uBA85" }), _jsx("textarea", { value: description, disabled: readOnly, onChange: (event) => setDescription(event.target.value) })] }), _jsxs("label", { className: styles.field, children: [_jsx("span", { children: "Authority Level" }), _jsx("select", { value: levelId, disabled: readOnly, onChange: (event) => setLevelId(event.target.value), children: [...policy.levels].sort((a, b) => b.rank - a.rank).map((level) => _jsxs("option", { value: level.id, children: [level.name, " \u00B7 L", level.rank] }, level.id)) })] }), _jsxs("div", { children: [_jsxs("div", { className: styles.permissionToolbar, children: [_jsxs("div", { children: [_jsx("h3", { children: "Permission Matrix" }), _jsx("span", { className: styles.hint, children: readOnly
                                                    ? `사용 ${permissions.length}개 · 위임 ${delegations.length}개`
                                                    : `위임 가능한 권한 ${availablePermissions.length}개만 표시` })] }), _jsxs("label", { className: styles.permissionSearch, children: [_jsx("span", { className: styles.visuallyHidden, children: "\uAD8C\uD55C \uAC80\uC0C9" }), _jsx("input", { value: permissionQuery, onChange: (event) => setPermissionQuery(event.target.value), placeholder: "\uAD8C\uD55C \uAC80\uC0C9" })] })] }), _jsxs("div", { className: styles.permissionMatrix, children: [_jsxs("div", { className: styles.permissionHeader, children: [_jsx("span", { children: "\uAD8C\uD55C" }), _jsx("span", { children: "\uC0AC\uC6A9" }), _jsx("span", { children: "\uC704\uC784" })] }), visiblePermissions.map((permission) => (_jsxs("div", { className: styles.permissionRow, children: [_jsxs("span", { className: styles.permissionName, children: [_jsx("code", { children: permission.key }), _jsxs("span", { children: [permission.label, " \u00B7 ", permission.category] })] }), _jsx("label", { className: styles.checkboxCell, children: _jsx("input", { "aria-label": `${permission.key} 사용`, type: "checkbox", checked: permissions.includes(permission.key), disabled: readOnly, onChange: (event) => togglePermission(permission.key, event.target.checked) }) }), _jsx("label", { className: styles.checkboxCell, children: _jsx("input", { "aria-label": `${permission.key} 위임`, type: "checkbox", checked: delegations.includes(permission.key), disabled: readOnly || !permissions.includes(permission.key) || !permission.delegatable || permission.protected, onChange: (event) => toggleDelegation(permission.key, event.target.checked) }) })] }, permission.key))), visiblePermissions.length === 0 ? _jsx("div", { className: styles.permissionEmpty, children: "\uAC80\uC0C9 \uC870\uAC74\uC5D0 \uB9DE\uB294 \uAD8C\uD55C\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." }) : null] })] }), _jsxs("div", { className: styles.stack, children: [_jsxs("div", { className: styles.panelHeader, children: [_jsx("h3", { children: "\uD544\uB4DC \uC811\uADFC \uC81C\uD55C" }), _jsx("span", { className: styles.hint, children: "\uBE44\uC6CC \uB450\uBA74 \uD574\uB2F9 \uB9AC\uC18C\uC2A4\uC758 \uBAA8\uB4E0 \uD544\uB4DC\uB97C \uD5C8\uC6A9\uD569\uB2C8\uB2E4." })] }), _jsx(ScopeTreeSelector, { label: "\uD544\uB4DC \uC811\uADFC Scope", description: "Collection \uB610\uB294 \uAC1C\uBCC4 Document\uB97C \uC120\uD0DD\uD558\uC138\uC694. \uC0C1\uC704 \uC601\uC5ED\uC740 \uC704\uCE58\uB97C \uC124\uBA85\uD558\uAE30 \uC704\uD574 \uD568\uAED8 \uD45C\uC2DC\uB429\uB2C8\uB2E4.", resources: policy.resources, value: fieldResourceId, onChange: setFieldResourceId, allowEmpty: true, isDisabled: readOnly, isSelectable: ({ type }) => type === "collection" || type === "document" }), fieldResourceId ? _jsxs("div", { className: styles.fieldRow, children: [_jsxs("label", { className: styles.field, children: [_jsx("span", { children: "\uC77D\uAE30 \uD5C8\uC6A9 \uD544\uB4DC" }), _jsx("input", { value: readableFields, disabled: readOnly, onChange: (event) => setReadableFields(event.target.value), placeholder: "title, summary" })] }), _jsxs("label", { className: styles.field, children: [_jsx("span", { children: "\uC4F0\uAE30 \uD5C8\uC6A9 \uD544\uB4DC" }), _jsx("input", { value: writableFields, disabled: readOnly, onChange: (event) => setWritableFields(event.target.value), placeholder: "title" })] })] }) : null] }), _jsxs("div", { className: styles.formActions, children: [onDelete ? _jsx(Button, { variant: "danger", onPress: onDelete, isDisabled: isPending, children: "\uC0AD\uC81C" }) : null, _jsx(Button, { variant: "quiet", onPress: onCancel, isDisabled: isPending, children: "\uCDE8\uC18C" }), !readOnly ? _jsx(Button, { onPress: () => onSave({
...
function EffectivePermissionList({ policy, results, }) {
    ...
    return (_jsxs("section", { className: styles.panel, "aria-label": "\uC0AC\uC6A9\uC790\uBCC4 Effective Permission", "aria-live": "polite", children: [_jsxs("div", { className: styles.panelHeader, children: [_jsxs("div", { children: [_jsx("h2", { children: "\uC804\uCCB4 \uC720\uD6A8 \uAD8C\uD55C" }), _jsx("span", { className: styles.hint, children: resourcePathOf(policy, firstDecision?.resourceId ?? "") })] }), _jsxs(Badge, { tone: allowedCount > 0 ? "success" : "neutral", children: [allowedCount, "/", supportedCount, " \uD5C8\uC6A9", unsupportedCount ? ` · ${unsupportedCount}개 대상 context 필요` : ""] })] }), _jsx("div", { className: styles.effectiveList, children: sorted.map(({ permission, supported, decision }) => (_jsxs("article", { className: styles.effectiveItem, "data-allowed": decision?.allowed === true, children: [_jsxs("div", { children: [_jsx("strong", { children: permission.label }), _jsx("code", { children: permission.key })] }), _jsx(Badge, { tone: !supported ? "neutral" : decision?.allowed ? "success" : "danger", children: !supported ? "Context 필요" : decision?.allowed ? "Allowed" : "Denied" }), _jsx("span", { children: supported ? decision?.reasonCode : hierarchyContextDescription(permission.hierarchyGuard) })] }, permission.key))) })] }));
}

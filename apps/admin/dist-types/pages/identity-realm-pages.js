...
function RealmSettingsForm({ realm }) {
    ...
    return (_jsxs("section", { className: styles.panel, "aria-labelledby": "realm-settings-title", children: [_jsx(SectionHeader, { id: "realm-settings-title", title: "Realm \uC124\uC815", description: `Realm Revision ${realm.revision}을 기준으로 충돌 없이 저장합니다.` }), _jsxs("form", { className: styles.formStack, onSubmit: (event) => { event.preventDefault(); if (editable)

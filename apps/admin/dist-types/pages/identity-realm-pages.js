...
export function IdentityRealmDetailPage() {
    ...
    return (_jsxs(Page, { children: [_jsx(PageHeader, { eyebrow: realm.data.kind === "system" ? "System identity realm" : "Content identity realm", title: realm.data.name, description: realm.data.kind === "system"
                    ...
                    : "Global Identity 자격 증명과 이 Realm의 Membership·Subject·Profile 연결을 관리합니다.", actions: _jsxs(_Fragment, { children: [_jsx(RealmStatusBadge, { realm: realm.data }), _jsx(Button, { variant: "secondary", onPress: () => navigate("/admin/realms"), children: "\uBAA9\uB85D\uC73C\uB85C" })] }) }), _jsx(RealmIdentitySummary, { realm: realm.data }), realm.data.kind === "system" ? (_jsxs(Callout, { tone: "info", children: [_jsx("strong", { children: "System Realm\uC740 \uC774 \uD654\uBA74\uC5D0\uC11C \uC218\uC815\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4." }), " Content Realm\uC5D0 \uC6B4\uC601 \uACC4\uC815\uC744 \uC5F0\uACB0\uD574\uB3C4 System \uAD8C\uD55C\uC774 \uC804\uD30C\uB418\uC9C0\uB294 \uC54A\uC2B5\uB2C8\uB2E4."] })) : (_jsxs(_Fragment, { children: [realm.data.status === "provisioning" ? (_jsxs(Callout, { tone: "warning", children: [_jsx("strong", { children: "\uAE30\uBCF8 \uC778\uC99D \uC2A4\uD0A4\uB9C8\uB97C \uB9CC\uB4E4\uBA74 Realm\uC744 \uBC14\uB85C \uD65C\uC131\uD654\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." }), _jsx("p", { children: "\uB85C\uADF8\uC778 identifier\uC640 \uAE30\uBCF8 Profile \uD544\uB4DC\uB97C \uD655\uC778\uD558\uBA74 Collection \uC0DD\uC131, stable ID \uBC1C\uAE09, Realm \uC5F0\uACB0\uACFC Schema \uC801\uC6A9\uC744 \uD55C \uBC88\uC5D0 \uCC98\uB9AC\uD569\uB2C8\uB2E4." }), _jsxs("div", { className: styles.formActions, children: [_jsx(Button, { onPress: () => setProfileSetupOpen(true), children: "\uAE30\uBCF8 \uC778\uC99D \uC2A4\uD0A4\uB9C8 \uC0DD\uC131" }), _jsx(Button, { variant: "secondary", onPress: () => navigate("/admin/schema/new"), children: "\uC9C1\uC811 \uC124\uACC4" })] })] })) : null, realm.data.status === "disabled" ? (_jsxs(Callout, { tone: "warning", children: [_jsx("strong", { children: "\uC774 Realm\uC740 \uBE44\uD65C\uC131 \uC0C1\uD0DC\uC785\uB2C8\uB2E4." }), " \uC2E0\uADDC \uC138\uC158, Membership provisioning\uACFC Full Access grant\uAC00 \uCC28\uB2E8\uB429\uB2C8\uB2E4."] })) : null, _jsx(RealmDetailTabs, { active: detailTab, hasProfile: realm.data.profileCollectionId !== undefined, fullAccessActive: (fullAccess.data?.activeBinding !== undefined && isActiveFullAccess(fullAccess.data.activeBinding))
...
function RealmDetailTabs({ active, hasProfile, fullAccessActive, onChange }) {
    ...
    return (_jsx("div", { className: styles.detailTabs, role: "tablist", "aria-label": "Realm \uC0C1\uC138 \uC601\uC5ED", children: tabs.map((tab) => (_jsxs("button", { type: "button", role: "tab", "aria-selected": active === tab.id, disabled: tab.disabled, onClick: () => onChange(tab.id), children: [tab.label, tab.id === "access" && fullAccessActive ? _jsx("span", { className: styles.detailTabDangerDot, "aria-label": "Full Access \uC0AC\uC6A9 \uC911" }) : null] }, tab.id))) }));
}
function RealmAccessOverview({ realm, mode }) {
    const navigate = useNavigate();
    const target = mode === "basic" ? "grades" : "roles";
    return (_jsxs("section", { className: styles.panel, "aria-labelledby": "realm-access-overview-title", children: [_jsx(SectionHeader, { id: "realm-access-overview-title", title: "Realm \uAD8C\uD55C", description: "\uC774 Realm \uC548\uC5D0\uC11C \uC0AC\uC6A9\uD560 \uB4F1\uAE09, \uC5ED\uD560\uACFC \uC0AC\uC6A9\uC790 \uBC30\uC815\uC744 \uAD00\uB9AC\uD569\uB2C8\uB2E4.", actions: _jsx(Button, { onPress: () => navigate(`/admin/realms/${encodeURIComponent(realm.realmId)}/access/${target}`), isDisabled: realm.status !== "active", children: "Realm \uAD8C\uD55C \uAD00\uB9AC" }) }), _jsx("p", { className: styles.compactHint, children: "\uC77C\uBC18 \uAD8C\uD55C\uC740 \uC5ED\uD560\uACFC Scope\uB85C \uAD00\uB9AC\uD569\uB2C8\uB2E4. Full Access\uB294 CMS Owner\uAC00 \uAE30\uAC04\uC744 \uC815\uD574 \uC815\uCC45\uC744 \uC9C1\uC811 \uBCF5\uAD6C\uD560 \uB54C\uB9CC \uC0AC\uC6A9\uD569\uB2C8\uB2E4." })] }));
}
function ProfileSchemaSetupDialog({ realm, error, isPending, onCancel, onConfirm }) {
    ...
    const errorMessage = converted?.code === "SCHEMA_QUICK_SETUP_DRAFT_CONFLICT"
        ...
        : converted?.code === "COLLECTION_NAME_CONFLICT"
            ...
            : converted?.message;
    return (_jsx(ConfirmDialog, { title: "\uAE30\uBCF8 \uC778\uC99D \uC2A4\uD0A4\uB9C8 \uC0DD\uC131", confirmLabel: "\uC0DD\uC131\uD558\uACE0 Realm \uD65C\uC131\uD654", isPending: isPending, isConfirmDisabled: collectionName.trim() === ""
...
function RealmOwnerSection({ realm, owner, memberships, identities, systemRealmId }) {
    ...
    return (_jsxs("section", { className: styles.panel, "aria-labelledby": "realm-owner-title", "data-owner-status": owner.data?.status, children: [_jsx(SectionHeader, { id: "realm-owner-title", title: "Realm Owner", description: "\uC774 Realm\uC758 \uC2E4\uC81C \uC0AC\uB78C \uCD5C\uACE0\uAD00\uB9AC\uC790\uC640 \uC6B4\uC601 \uC5F0\uC18D\uC131\uC744 \uAD00\uB9AC\uD569\uB2C8\uB2E4.", actions: owner.data ? (_jsx(Button, { variant: owner.data.status === "healthy" ? "secondary" : "danger", onPress: openDialog, isDisabled: realm.status !== "active" || candidates.length === 0, children: operationLabel })) : undefined }), owner.isPending ? _jsx(PageLoading, { label: "Realm Owner \uC0C1\uD0DC\uB97C \uBD88\uB7EC\uC624\uB294 \uC911" }) : null, owner.isError ? _jsx(LoadError, { error: owner.error, onRetry: () => void owner.refetch() }) : null, owner.data?.status === "healthy" && owner.data.owner ? (_jsxs("div", { className: styles.ownerSummary, children: [_jsxs("div", { children: [_jsx("strong", { children: owner.data.owner.primaryIdentifier }), _jsx("span", { children: "Primary Realm Owner" })] }), _jsxs("div", { className: styles.rowActions, children: [_jsx(Badge, { tone: owner.data.owner.identityActive ? "success" : "danger", children: owner.data.owner.identityActive ? "계정 활성" : "계정 비활성" }), _jsx(MembershipStatusBadge, { status: owner.data.owner.membershipStatus })] }), _jsxs(DisplayModeGate, { minimum: "advanced", children: [_jsx(IdValue, { label: "Global Identity ID", value: owner.data.owner.globalIdentityId }), _jsx(IdValue, { label: "Owner Subject ID", value: owner.data.owner.subjectId })] })] })) : null, owner.data?.status === "ownerless" ? (_jsxs(Callout, { tone: "error", children: [_jsx("strong", { children: "\uC6B4\uC601 Owner\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." }), " \uD65C\uC131 \uC6B4\uC601\uC790\uB97C \uC5F0\uACB0\uD55C \uB4A4 Owner\uB97C \uC9C0\uC815\uD574\uC57C \uC774 Realm\uC758 \uC815\uC0C1\uC801\uC778 \uAD8C\uD55C \uAD00\uB9AC \uC8FC\uCCB4\uAC00 \uC0DD\uAE41\uB2C8\uB2E4."] })) : null, owner.data?.status === "invalid" ? (_jsxs(Callout, { tone: "error", children: [_jsx("strong", { children: "Realm Owner \uC0C1\uD0DC\uAC00 \uC190\uC0C1\uB418\uC5C8\uC2B5\uB2C8\uB2E4." }), " ", owner.data.issueCode ? _jsx("code", { children: owner.data.issueCode }) : null, " \uC801\uACA9 \uC6B4\uC601\uC790\uB97C \uC120\uD0DD\uD574 \uBCF5\uAD6C\uD558\uC138\uC694."] })) : null, owner.data && candidates.length === 0 ? (_jsx("p", { className: styles.compactHint, children: "Owner\uB85C \uC9C0\uC815\uD560 \uB2E4\uB978 \uD65C\uC131 System \uC6B4\uC601\uC790 Membership\uC774 \uC5C6\uC2B5\uB2C8\uB2E4. \uC544\uB798\uC5D0\uC11C \uAE30\uC874 \uC6B4\uC601\uC790\uB97C \uBA3C\uC800 \uC5F0\uACB0\uD558\uC138\uC694." })) : null, dialogOpen && owner.data ? (_jsx(ConfirmDialog, { title: operationLabel, confirmLabel: operationLabel, danger: operation !== "assign", isPending: changeOwner.isPending, isConfirmDisabled: targetMembershipId === "" || reason.trim() === "" || password === "", onCancel: () => { setDialogOpen(false); changeOwner.reset(); }, onConfirm: () => changeOwner.mutate(), children: _jsxs("div", { className: styles.dialogStack, children: [_jsx("p", { children: "CMS Owner \uC790\uC2E0\uC740 \uB300\uC0C1\uC774 \uB420 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uC11C\uBC84\uAC00 \uB300\uC0C1 \uACC4\uC815, Membership\uACFC \uC0AC\uB78C Subject\uB97C \uB2E4\uC2DC \uAC80\uC99D\uD569\uB2C8\uB2E4." }), _jsx(SelectField, { label: "\uC0C8 Realm Owner", value: targetMembershipId, options: candidates.map((membership) => ({
                            ...
                            })), onChange: setTargetMembershipId }), _jsx(TextAreaField, { label: "\uBCC0\uACBD \uC0AC\uC720", value: reason, onChange: setReason, rows: 3, isRequired: true }), operation === "transfer" ? (_jsxs("div", { className: styles.dialogStack, children: [_jsx(CheckboxField, { isSelected: revokePreviousSessions, onChange: setRevokePreviousSessions, children: "\uAE30\uC874 Owner\uC758 \uD65C\uC131 \uC138\uC158 \uD3D0\uAE30" }), _jsx(CheckboxField, { isSelected: suspendPreviousMembership, onChange: setSuspendPreviousMembership, children: "\uAE30\uC874 Owner Membership\uB3C4 \uD568\uAED8 \uC815\uC9C0" })] })) : null, _jsx(TextInput, { label: "\uD604\uC7AC System \uACC4\uC815 \uBE44\uBC00\uBC88\uD638", type: "password", autoComplete: "current-password", value: password, onChange: setPassword, isRequired: true }), _jsx(MutationError, { error: changeOwner.error })] }) })) : null] }));
}
function MembershipSection({ realm, memberships, identities, systemRealmId }) {
    ...
    return (_jsxs("section", { className: styles.panel, "aria-labelledby": "membership-title", children: [_jsx(SectionHeader, { id: "membership-title", title: "\uC0AC\uC6A9\uC790 \uD560\uB2F9", description: "\uC774 Realm\uC5D0 \uC5F0\uACB0\uB41C \uC0AC\uC6A9\uC790\uB97C \uD655\uC778\uD558\uACE0 \uD544\uC694\uD55C \uC5F0\uACB0 \uC791\uC5C5\uC744 \uC2E4\uD589\uD569\uB2C8\uB2E4.", actions: _jsxs("div", { className: styles.rowActions, children: [_jsx(Button, { onPress: () => { register.reset(); setNewProfileError(null); setMembershipAction("register"); }, isDisabled: !canRegister, children: "\uC0C8 \uC0AC\uC6A9\uC790" }), _jsx(Button, { variant: "secondary", onPress: () => { provision.reset(); setProfileError(null); setMembershipAction("provision"); }, isDisabled: !canProvision || identities.isPending || candidates.length === 0, children: "\uAE30\uC874 \uC6B4\uC601\uC790 \uC5F0\uACB0" })] }) }), realm.status !== "active" ? (_jsx(Callout, { tone: "warning", children: "\uC774 Realm\uC774 \uD65C\uC131 \uC0C1\uD0DC\uAC00 \uB418\uC5B4\uC57C \uC0AC\uC6A9\uC790\uB97C \uC5F0\uACB0\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." })) : null, identities.isError ? _jsx(LoadError, { error: identities.error, onRetry: () => void identities.refetch() }) : null, !realm.authentication.acceptSystemIdentities ? (_jsx("p", { className: styles.compactHint, children: "\uAE30\uC874 \uC6B4\uC601\uC790 \uC5F0\uACB0\uC740 Realm \uC124\uC815\uC5D0\uC11C System Identity Membership\uC744 \uD5C8\uC6A9\uD558\uBA74 \uC0AC\uC6A9\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." })) : realm.status === "active" && !identities.isPending && candidates.length === 0 ? (_jsx("p", { className: styles.compactHint, children: "\uC5F0\uACB0 \uAC00\uB2A5\uD55C \uC6B4\uC601\uC790 \uACC4\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })) : null, memberships.isPending ? _jsx(PageLoading, { label: "Membership\uC744 \uBD88\uB7EC\uC624\uB294 \uC911" }) : null, memberships.isError ? _jsx(LoadError, { error: memberships.error, onRetry: () => void memberships.refetch() }) : null, memberships.data?.items.length === 0 ? _jsx(EmptyState, { title: "\uC5F0\uACB0\uB41C \uC0AC\uC6A9\uC790\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4", description: "\uC0C1\uB2E8 \uC791\uC5C5\uC73C\uB85C \uC0AC\uC6A9\uC790\uB97C \uC5F0\uACB0\uD558\uAC70\uB098 \uC77C\uBC18 \uC0AC\uC6A9\uC790\uAC00 \uAC00\uC785/JIT \uB85C\uADF8\uC778\uD558\uBA74 \uC5EC\uAE30\uC5D0 \uD45C\uC2DC\uB429\uB2C8\uB2E4." }) : null, memberships.data && memberships.data.items.length > 0 ? (_jsx("div", { className: styles.tableWrap, children: _jsxs("table", { className: `${styles.table} ${styles.membershipTable}`, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\uC0AC\uC6A9\uC790" }), _jsx("th", { children: "Realm Subject" }), _jsx("th", { children: "Profile" }), _jsx("th", { children: "\uC0C1\uD0DC" }), _jsx("th", { children: "\uC5F0\uACB0 \uBC29\uC2DD" }), _jsx("th", { children: "\uC791\uC5C5" })] }) }), _jsx("tbody", { children: memberships.data.items.map((membership) => {
                                const identity = membership.identity ?? identityById.get(membership.globalIdentityId);
                                return (_jsxs("tr", { children: [_jsxs("td", { children: [_jsx("strong", { children: identity?.primaryIdentifier ?? "Identifier 미제공" }), _jsxs(DisplayModeGate, { minimum: "advanced", children: [_jsx(IdValue, { label: "Global Identity ID", value: membership.globalIdentityId }), _jsx(IdValue, { label: "Membership ID", value: membership.membershipId })] })] }), _jsx("td", { children: _jsx("code", { className: styles.compactCode, children: membership.subjectId }) }), _jsx("td", { children: _jsx("code", { className: styles.compactCode, children: membership.profileDocumentId ?? "프로비저닝 중" }) }), _jsx("td", { children: _jsx(MembershipStatusBadge, { status: membership.status }) }), _jsxs("td", { children: [provisionedByLabel(membership.provisionedBy), _jsxs("span", { className: styles.secondaryLine, children: ["Revision ", membership.revision] })] }), _jsx("td", { children: _jsxs("div", { className: styles.rowActions, children: [membership.status === "active" && realm.kind === "content" ? (_jsx(Button, { size: "small", variant: "secondary", isDisabled: realm.status !== "active" || promote.isPending, onPress: () => { setPromoting(membership); setPromoteReauthPassword(""); }, children: "\uAD00\uB9AC\uC790\uB85C \uC9C0\uC815" })) : null, membership.status === "active" ? (_jsx(Button, { size: "small", variant: "danger", isDisabled: realm.status !== "active" || changeStatus.isPending, onPress: () => changeStatus.mutate({ membership, status: "suspended" }), children: "\uC815\uC9C0" })) : membership.status === "suspended" ? (_jsx(Button, { size: "small", variant: "secondary", isDisabled: realm.status !== "active" || changeStatus.isPending, onPress: () => changeStatus.mutate({ membership, status: "active" }), children: "\uC7AC\uD65C\uC131\uD654" })) : _jsx(Badge, { tone: "warning", children: "\uC644\uB8CC \uB300\uAE30" })] }) })] }, membership.membershipId));

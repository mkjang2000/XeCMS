...
export function SchemaEditorPage() {
    ...
    return (_jsxs(Page, { children: [_jsx(PageHeader, { eyebrow: "Schema builder", title: isNew ? "새 콘텐츠 타입" : `${collectionQuery.data?.label || collectionQuery.data?.name} 스키마`, description: "\uAC04\uB2E8\uD55C \uD544\uB4DC\uB294 \uC2DC\uAC01 \uD3B8\uC9D1\uAE30\uB85C, \uC911\uCCA9 \uAD6C\uC870\uC640 \uC7AC\uC0AC\uC6A9 \uCEF4\uD3EC\uB10C\uD2B8\uB294 canonical manifest\uC5D0\uC11C \uC644\uC804\uD788 \uC81C\uC5B4\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.", actions: _jsx(Button, { variant: "secondary", onPress: () => navigate("/admin/schema/tools"), children: "Manifest \u00B7 TypeScript" }) }), diagnostics.data && !editable ? (_jsxs(Callout, { tone: "warning", children: ["Schema mode\uAC00 ", _jsx("strong", { children: diagnostics.data.schemaMode }), "\uC774\uBBC0\uB85C \uC774 \uD654\uBA74\uC758 \uC800\uC7A5\uACFC \uC801\uC6A9\uC774 \uC7A0\uACA8 \uC788\uC2B5\uB2C8\uB2E4."] })) : null, isVersionConflict ? _jsx(ConflictNotice, { onReload: () => void reloadLatest() }) : null, mutationError && !isVersionConflict && mutationError.message !== "DUPLICATE_FIELD_NAME" && mutationError.message !== "INVALID_AUTH_CONFIGURATION" ? _jsx(LoadError, { error: mutationError }) : null, _jsxs("form", { className: styles.formStack, onSubmit: handleSubmit((values) => mutation.mutate(values)), children: [_jsxs("section", { className: styles.card, "aria-labelledby": "collection-settings-heading", children: [_jsx(SectionHeader, { id: "collection-settings-heading", title: "\uCF58\uD150\uCE20 \uD0C0\uC785 \uC124\uC815", description: "API \uC2DD\uBCC4\uC790, \uCF58\uD150\uCE20 \uC720\uD615\uACFC \uACC4\uCE35 \uB3D9\uC791\uC744 \uC124\uC815\uD569\uB2C8\uB2E4." }), _jsxs("div", { className: styles.settingsGrid, children: [_jsx(Controller, { control: control, name: "name", rules: { required: "컬렉션 이름을 입력해 주세요.", pattern: { value: SCHEMA_NAME_PATTERN, message: SCHEMA_NAME_ERROR_MESSAGE } }, render: ({ field: { ref, ...field }, fieldState }) => _jsx(TextInput, { inputRef: ref, label: "\uC774\uB984", description: "API\uC640 \uC800\uC7A5\uC18C\uC5D0\uC11C \uC720\uC9C0\uB418\uB294 \uC774\uB984\uC785\uB2C8\uB2E4.", isRequired: true, maxLength: 64, errorMessage: fieldState.error?.message, ...field }) }), _jsx(Controller, { control: control, name: "label", render: ({ field: { ref, ...field } }) => _jsx(TextInput, { inputRef: ref, label: "\uD45C\uC2DC \uC774\uB984", ...field }) }), _jsx(Controller, { control: control, name: "kind", render: ({ field }) => _jsx(SelectField, { ...field, label: "\uC720\uD615", options: [{ value: "collection", label: "컬렉션 · 여러 문서" }, { value: "singleton", label: "싱글턴 · 문서 하나" }] }) })] }), _jsxs("div", { className: styles.hierarchyPanel, children: [_jsx(Controller, { control: control, name: "hierarchyEnabled", render: ({ field }) => _jsx(CheckboxField, { isSelected: field.value, onChange: field.onChange, children: "\uACC4\uCE35\uD615 \uCF58\uD150\uCE20 \uC0AC\uC6A9" }) }), hierarchyEnabled ? (_jsxs("div", { className: styles.settingsGrid, children: [_jsx(Controller, { control: control, name: "maxDepth", rules: { min: { value: 1, message: "1 이상의 깊이를 입력해 주세요." } }, render: ({ field, fieldState }) => _jsx(TextInput, { ...field, type: "number", label: "\uCD5C\uB300 \uAE4A\uC774", description: "\uBE44\uC6B0\uBA74 \uC81C\uD55C\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.", errorMessage: fieldState.error?.message }) }), _jsx(Controller, { control: control, name: "ordering", render: ({ field }) => _jsx(SelectField, { ...field, label: "\uC815\uB82C \uBC29\uC2DD", options: [{ value: "manual", label: "수동 정렬" }, { value: "created-at", label: "생성일" }, { value: "field", label: "특정 필드" }] }) }), ordering === "field" ? _jsx(Controller, { control: control, name: "orderingFieldId", rules: { required: "정렬 필드 stable ID를 입력해 주세요." }, render: ({ field, fieldState }) => _jsx(TextInput, { ...field, label: "\uC815\uB82C \uD544\uB4DC stable ID", isRequired: true, errorMessage: fieldState.error?.message }) }) : null, _jsx(Controller, { control: control, name: "slugPath", render: ({ field }) => _jsx(CheckboxField, { isSelected: field.value, onChange: field.onChange, children: "slug \uACBD\uB85C \uC0AC\uC6A9" }) }), _jsx(Controller, { control: control, name: "permissionInheritance", render: ({ field }) => _jsx(CheckboxField, { isSelected: field.value, onChange: field.onChange, children: "\uBD80\uBAA8 \uAD8C\uD55C \uC0C1\uC18D" }) })] })) : null] })] }), _jsxs("section", { className: styles.card, "aria-labelledby": "collection-auth-heading", children: [_jsx(SectionHeader, { id: "collection-auth-heading", title: "\uCF58\uD150\uCE20 \uACC4\uC815 \uC778\uC99D", description: "\uC774 Collection\uC744 \uC0AC\uC804\uC5D0 \uC0DD\uC131\uB41C Content Realm\uC758 Profile\uACFC \uB85C\uADF8\uC778 identifier\uB85C \uC5F0\uACB0\uD569\uB2C8\uB2E4." }), _jsxs("div", { className: styles.authPanel, children: [_jsx(Controller, { control: control, name: "authEnabled", render: ({ field }) => (_jsx(CheckboxField, { isSelected: field.value, onChange: field.onChange, children: "\uCF58\uD150\uCE20 \uACC4\uC815 \uC778\uC99D \uC0AC\uC6A9" })) }), watchedValues.authEnabled ? (_jsxs(_Fragment, { children: [realms.isError ? (_jsx(Callout, { tone: "error", children: "Realm \uBAA9\uB85D\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. Identity Realm \uD654\uBA74\uACFC \uC5F0\uACB0 \uC0C1\uD0DC\uB97C \uD655\uC778\uD574 \uC8FC\uC138\uC694." })) : null, !realms.isPending && !realms.isError && contentRealms.length === 0 ? (_jsx(Callout, { tone: "warning", children: "\uBA3C\uC800 Identity Realm \uD654\uBA74\uC5D0\uC11C Content Realm\uC744 \uC0DD\uC131\uD574 \uC8FC\uC138\uC694." })) : null, _jsxs("div", { className: styles.settingsGrid, children: [_jsx(Controller, { control: control, name: "authRealmKey", render: ({ field, fieldState }) => (_jsx(SelectField, { label: "Content Realm", description: "Schema\uC5D0\uB294 Realm ID\uAC00 \uC544\uB2C8\uB77C \uBCC0\uACBD\uB418\uC9C0 \uC54A\uB294 Realm key\uB97C \uC800\uC7A5\uD569\uB2C8\uB2E4.", value: field.value, onChange: (realmKey) => {

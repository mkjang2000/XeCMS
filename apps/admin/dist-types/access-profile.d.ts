...
export declare function useAccessProfile(scope: string, checks: readonly AccessEvaluationCheck[]): import("@tanstack/react-query").UseQueryResult<NoInfer<import("@xecms/admin").AccessEvaluationProfile>, Error>;

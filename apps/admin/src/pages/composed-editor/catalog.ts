...
export function paletteEntry(kind: string): PaletteEntry | undefined {
  return PALETTE.find((entry) => entry.kind === kind);
}

export function nextComponentId(existing: readonly ComponentDefinition[], kind: string): string {

...
export function createAdminApi(client: XeCmsClient = createXeCmsClient()): AdminApi {
  return {
    ...
    identityRealms: {
      ...
      putCollectionEntitlement: (realmId, collectionId, input) => call(() =>
        client.identityRealms.putCollectionEntitlement(realmId, collectionId, input)),
      ...
      putManagementDelegation: (realmId, managedRealmId, input) => call(() =>
        client.identityRealms.putManagementDelegation(realmId, managedRealmId, input)),
